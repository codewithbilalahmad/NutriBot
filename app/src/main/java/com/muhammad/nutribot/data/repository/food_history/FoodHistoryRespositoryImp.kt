...
import com.muhammad.nutribot.data.local.mappers.toHistoryFoodEntity
...
class FoodHistoryRespositoryImp(
    ...
    override suspend fun upsertHistoryFood(historyFood: HistoryFood) {
        foodHistoryFoodDao.upsertHistoryFood(historyFood.toHistoryFoodEntity())
    }
